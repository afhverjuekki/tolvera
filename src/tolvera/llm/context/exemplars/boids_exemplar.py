"""
Golden Exemplar: Boids Flocking Behavior
========================================
This exemplar demonstrates the classic boids algorithm with separation,
alignment, and cohesion forces, plus inter-species avoidance.
Key patterns: multi-component forces, species filtering, proper variable declaration.
"""
