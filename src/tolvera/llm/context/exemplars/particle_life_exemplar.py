"""
Golden Exemplar: Particle Life (Multi-Species Interactions)
===========================================================
This exemplar demonstrates complex multi-species attraction/repulsion
using an interaction matrix. Key patterns: 2D state arrays, species
interactions, distance-based forces with smooth falloff.
"""
...
# Export exemplar
__all__ = ['PARTICLE_LIFE_EXEMPLAR']